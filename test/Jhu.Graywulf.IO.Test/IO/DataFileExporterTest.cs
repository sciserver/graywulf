...
namespace Jhu.Graywulf.IO
{
    ...
    public class DataFileExporterTest : TestClassBase
    {
        private IDataFileExporter GetDataFileExporter(string name, bool remote)
        {
            ...
            source.Dataset = new Jhu.Graywulf.Schema.SqlServer.SqlServerDataset(Jhu.Graywulf.Test.Constants.TestDatasetName, Jhu.Graywulf.Test.AppSettings.SqlServerSchemaTestConnectionString);
