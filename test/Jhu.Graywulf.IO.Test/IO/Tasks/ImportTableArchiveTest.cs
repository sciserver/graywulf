...
namespace Jhu.Graywulf.IO.Tasks
{
    ...
    public class ImportTableArchiveTest : TestClassBase
    {
        ...
        private ServiceModel.ServiceProxy<IImportTableArchive> GetImportTableArchiveTask(string path, string tableNamePattern, bool remote, bool generateIdentityColumn)
        {
            ...
            {
                it = new ServiceModel.ServiceProxy<IImportTableArchive>(new ImportTableArchive());
            }
        ...
        private void ImportTableArchiveTestHelper(ArchiveType type, bool remote, bool generateIdentity)
        {
            ...
            using (var it = GetImportTableArchiveTask(path, tableNamePattern, remote, generateIdentity))
            {
