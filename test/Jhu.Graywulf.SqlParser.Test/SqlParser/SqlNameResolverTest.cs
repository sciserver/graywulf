...
#region Function tests
        ...
        {
            var sql = "SELECT SystemFunction(1)";

            var qs = Parse(sql);

            var res = GenerateCode(qs);
            Assert.AreEqual("SELECT SystemFunction(1) AS [Col_0]", res);
        }
        ...
        public void ScalarFunctionTest()
        {
            ...
            var res = GenerateCode(qs);
            Assert.AreEqual("SELECT [Graywulf_Test].[dbo].[TestScalarFunction] AS [Col_0]", res);
        }
        ...
        public void TableValuedFunctionTest()
        {
            ...
            var res = GenerateCode(qs);
            Assert.AreEqual("SELECT [f].[b] AS [f_b], [f].[a] AS [f_a] FROM [Graywulf_Test].[dbo].[TestTableValuedFunction] AS [f]", res);
        }
