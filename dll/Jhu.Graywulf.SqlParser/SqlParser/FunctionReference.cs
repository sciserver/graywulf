...
namespace Jhu.Graywulf.SqlParser
{
    public class FunctionReference
    {
        ...
        public FunctionReference(FunctionCall fc)
        {
            InitializeMembers();
            InterpretFunctionCall(fc);
        }
        ...
        private void InterpretFunctionCall(FunctionCall fc)
        {
            var fi = fc.FunctionIdentifier;

            var fn = fi.FindDescendant<FunctionName>();
            if (fn != null)
            {
                datasetName = null;
                databaseName = null;
