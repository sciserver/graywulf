...
namespace Jhu.Graywulf.Sql.QueryTraversal
{
    ...
    /// </summary>
    class ArithmeticExpressionPostfixReshuffler : ExpressionPostfixReshuffler
    {
        public ArithmeticExpressionPostfixReshuffler(SqlQueryVisitor visitor, SqlQueryVisitorSink sink)
            : base(visitor, sink)
        {
