...
namespace Jhu.Graywulf.Web.Api
{
    public sealed class AdapterStream : Stream
    {
        ...
        private PendingIOQueue readQueue;
        private PendingIOQueue writeQueue;
        private bool noMoreData;
        private bool wasWriterInvoked;
        ...
        public override IAsyncResult BeginRead(byte[] buffer, int offset, int count, AsyncCallback callback, object state)
        {
            ...
            var ar = new ReadAsyncResult(callback, state);
        ...
        bool TryCompleteReadRequest(byte[] buffer, int offset, int count, IIORequestEventsHandler handler, out bool shouldInvokeWriter)
        {
        ...
        void InvokeWriter()
        {
            ...
            try
            {
                ...
                IAsyncResult invokeResult = this.writer.BeginInvoke(srcStream, onWriterInvokeCompleted, srcStream);
