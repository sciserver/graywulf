    ...
    public static class DataTypes
    {
        public static DataType Unknown
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameUnknown
                };
            }
        }
        ...
        public static DataType SqlTinyInt
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameTinyInt,
                    Type = typeof(Byte),
        ...
        public static DataType SqlSmallInt
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameSmallInt,
                    Type = typeof(Int16),
        ...
        public static DataType SqlInt
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameInt,
                    Type = typeof(Int32),
        ...
        public static DataType SqlBigInt
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameBigInt,
                    Type = typeof(Int64),
        ...
        public static DataType SqlBit
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameBit,
                    Type = typeof(Boolean),
        ...
        public static DataType SqlDecimal
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameDecimal,
                    Type = typeof(Decimal),
        ...
        public static DataType SqlSmallMoney
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameSmallMoney,
                    Type = typeof(Decimal),
        ...
        public static DataType SqlMoney
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameMoney,
                    Type = typeof(Decimal),
        ...
        public static DataType SqlReal
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameReal,
                    Type = typeof(Single),
        ...
        public static DataType SqlFloat
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameFloat,
                    Type = typeof(Double),
        ...
        public static DataType SqlDate
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameDate,
        ...
        public static DataType SqlTime
        {
            ...
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameTime,
        ...
        public static DataType SqlSmallDateTime
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameSmallDateTime,
                    Type = typeof(DateTime),
        ...
        public static DataType SqlDateTime
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameDateTime,
                    Type = typeof(DateTime),
        ...
        public static DataType SqlDateTime2
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameDateTime2,
                    Type = typeof(DateTime),
        ...
        public static DataType SqlDateTimeOffset
        {
            ...
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameDateTimeOffset,
        ...
        public static DataType SqlChar
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameChar,
                    Type = typeof(String),
        ...
        public static DataType SqlVarChar
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameVarChar,
                    Type = typeof(String),
        ...
        public static DataType SqlText
        {
            ...
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameText,
                    Type = typeof(String),
        ...
        public static DataType SqlNChar
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameNChar,
                    Type = typeof(String),
        ...
        public static DataType SqlNVarChar
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameNVarChar,
                    Type = typeof(String),
        ...
        public static DataType SqlNText
        {
            ...
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameNText,
                    Type = typeof(String),
        ...
        public static DataType SqlBinary
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameBinary,
                    Type = typeof(Byte[]),
        ...
        public static DataType SqlVarBinary
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameVarBinary,
                    Type = typeof(Byte[]),
        ...
        public static DataType SqlImage
        {
            ...
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameImage,
                    Type = typeof(Byte[]),
        ...
        public static DataType SqlTimestamp
        {
            ...
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameTimestamp,
                    Type = typeof(Byte[]),
        ...
        public static DataType SqlUniqueIdentifier
        {
            get
            {
                return new DataType()
                {
                    TypeName = SqlServer.Constants.TypeNameUniqueIdentifier,
                    Type = typeof(Guid),
