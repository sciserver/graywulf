...
namespace Jhu.Graywulf.Registry
{
    ...
    public static class Util
    {
        ...
        public static Dictionary<string, string> LoadSettings(string settings)
        {
            ...
            {
                res.Add(node.Name, node.Attributes["value"].Value);
            }

            return res;
        }

        public static string SaveSettings(Dictionary<string, string> settings)
        {
            XmlDocument xml = new XmlDocument();
            ...
            {
                XmlNode node = xml.CreateElement(i.Key);
