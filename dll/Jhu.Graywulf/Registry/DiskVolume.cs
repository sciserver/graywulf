...
namespace Jhu.Graywulf.Registry
{
    ...
    public partial class DiskVolume : Entity
    {
        ...
        public DiskVolume(Context context, Machine parent)
            : base(context, parent)
        {
            InitializeMembers();
        }
        ...
        /// <summary>
        /// Created a copy of the entity and saves it into the database.
        /// </summary>
        /// <param name="parent">New parent of the entity.</param>
        /// <returns>The new entity created.</returns>
        public DiskVolume CreateCopy(Machine parent)
        {
            DiskVolume nd = new DiskVolume(this);
            nd.Guid = Guid.Empty;
            nd.Parent = parent;
            nd.Save();
