...
namespace Jhu.Graywulf.Registry
{
    ...
    public partial class JobDefinition : Entity
    {
        ...
        public JobDefinition(Context context, Cluster parent)
            : base(context, parent)
        {
            InitializeMembers();
        }
        ...
        /// <param name="context">An object context class containing session information.</param>
        /// <param name="parent">The parent entity in the entity hierarchy.</param>
        public JobDefinition(Context context, Federation parent)
            : base(context, parent)
        {
            InitializeMembers();
        }
        ...
        public void DiscoverWorkflowParameters()
        {
            ...
            using (Jhu.Graywulf.Activities.ReflectionHelper rh = new Jhu.Graywulf.Activities.ReflectionHelper())
            {
                foreach (var par in rh.GetWorkflowParameters(this.workflowTypeName).Values)
                {
        ...
        public void DiscoverWorkflowCheckpoints()
        {
            ...
            using (Jhu.Graywulf.Activities.ReflectionHelper rh = new Jhu.Graywulf.Activities.ReflectionHelper())
            {
                res = rh.GetWorkflowCheckpoints(this.workflowTypeName);
            }
        ...
        public JobInstance CreateJobInstance(string queueName, ScheduleType scheduleType)
        {
            ...
            using (Graywulf.Activities.ReflectionHelper rh = new Activities.ReflectionHelper())
            {
                foreach (var par in rh.GetWorkflowParameters(this.workflowTypeName).Values)
                {
