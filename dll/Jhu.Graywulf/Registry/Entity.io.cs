...
namespace Jhu.Graywulf.Registry
{
    public partial class Entity : ContextObject
    {
        ...
        /// </remarks>
        internal int LoadFromDataReader(SqlDataReader dr)
        {
            if (!dr.HasRows)
            {
            ...
            this.concurrencyVersion = dr.GetInt32(++o);
        ...
        {
            if (entityType != EntityType.Unknown && entityReferences.Count > 0)
            {
        ...
        protected virtual void Create()
        {
            ...
            {
                AppendBasicParameters(cmd);
                cmd.Parameters.Add("@ConcurrencyVersion", SqlDbType.Int).Direction = ParameterDirection.Output;
                ...
                // Read return values
                this.concurrencyVersion = (int)cmd.Parameters["@ConcurrencyVersion"].Value;
        ...
        protected void CheckConcurrency()
        {
            ...
            using (SqlCommand cmd = Context.CreateStoredProcedureCommand(sql))
            {
                ...
                cmd.Parameters.Add("@ConcurrencyVersion", SqlDbType.Int).Value = this.concurrencyVersion;
        ...
        internal IEnumerable<Entity> EnumerateChildrenForSerialize()
        {
            yield return this;
            ...
            {
                foreach (Entity ee in e.EnumerateChildrenForSerialize())
                {
                    yield return ee;
                }
            }
