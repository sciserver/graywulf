...
namespace Jhu.Graywulf.Registry
{
    ...
    public partial class Machine : Entity
    {
        ...
        public Machine(Context context, MachineRole parent)
            : base(context, parent)
        {
            InitializeMembers();
        }
        ...
        public Machine CreateCopy(MachineRole parent)
        {
            Machine nm = new Machine(this);
            nm.Guid = Guid.Empty;
            nm.Parent = parent;
            nm.Name = string.Format("Copy of {0}", nm.Name);  // TODO add resource for format string?
            nm.Save();
