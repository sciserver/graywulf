...
namespace Jhu.Graywulf.Registry
{
    ...
    public abstract class JobFactoryBase : ContextObject
    {
        ...
        {
            return EntityFactory.CombineName(EntityType.QueueInstance, RegistryContext.Federation.ControllerMachineRole.GetFullyQualifiedName(), Constants.MaintenanceQueueName);
        }
    }
}
