        ...
        <ItemTemplate>
            <div class="gw-list-item gw-details-container">
                <div class="gw-list-row">
                    ...
                    <asp:Label runat="server" Text='<%# ((Jhu.Graywulf.Sql.Schema.Quantity)Eval("Metadata.Quantity")).ToString() %>' Width="250px" />
                    <asp:Label runat="server" Text='<%# ((Jhu.Graywulf.Sql.Schema.Unit)Eval("Metadata.Unit")).ToHtml() %>' Width="150px" />
                </div>
                <div class="gw-list-row">
                    <!--<span style="width: 32px"></span>-->
