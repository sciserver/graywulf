    ...
    <jgwc:MultiSelectListView runat="server" ID="listView" OnItemCreated="ListView_ItemCreated" OnItemCommand="ListView_ItemCommand">
        ...
        <ItemTemplate>
            <div class="gw-list-item gw-details-container">
                <div class="gw-list-row">
                    <asp:LinkButton runat="server" CommandName="Dataset" CommandArgument='<%# Eval("Name") %>'><asp:Image runat="server" ID="icon" Width="120px" Height="60px" style="margin-right: 8px" /></asp:LinkButton>
                    <asp:Label runat="server" Width="180px" CssClass="gw-list-multiline-span">
                        <asp:LinkButton runat="server" CommandName="Dataset" CommandArgument='<%# Eval("Name") %>'><%# Eval("Name") %></asp:LinkButton><br />
