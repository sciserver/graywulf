<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ErrorForm.ascx.cs" Inherits="Jhu.Graywulf.Web.UI.Apps.Jobs.ErrorForm" %>
<jgwuc:Form runat="server" Text="Error details" SkinID="ErrorJob">
    <FormTemplate>
        <p>
