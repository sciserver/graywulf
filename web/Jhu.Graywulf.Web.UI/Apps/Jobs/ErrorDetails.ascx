...
<div runat="server" class="gw-list-row gw-details-panel">
...
<div runat="server" class="gw-list-row gw-details-panel">
    <span style="width: 132px;"></span><!--
 --><span class="gw-list-span">If the error is permanent and you think it is a bug, 
        <asp:HyperLink runat="server" ID="errorInquiry" Text="send an inquiry" />.</span>
</div>