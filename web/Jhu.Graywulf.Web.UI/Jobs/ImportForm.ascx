<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImportForm.ascx.cs" Inherits="Jhu.Graywulf.Web.UI.Jobs.ImportForm" %>
<jgwc:Form runat="server" Text="Import details" SkinID="ImportJobDetails">
    <FormTemplate>
